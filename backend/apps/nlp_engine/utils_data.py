...
def load_models(flag):
    ...
    #LSI NAD LDA 
        ...
        return  lsi_model, lsi_dictionary, lsi_tfidf_model
    ...
    #LDA with verb
        ...
        return optimal_lda_model, optimal_lda_dictionary
    ...
    #BERT with kmeans
        ...
        return bert_model, cluster_keywords, sentence_model

    else:
        raise ValueError("Invalid flag provided. Use 'LDA', 'LSA', 'LDA_VERB', or 'BERT'.")